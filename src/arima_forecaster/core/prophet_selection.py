...
class ProphetModelSelector:
    ...
    def search(
        ...
        try:
            ...
            best_model = self._create_model(best_result['params'], country_holidays, custom_holidays)
    ...
    def _grid_search(
        ...
        if self.n_jobs == 1:
            ...
            with ThreadPoolExecutor(max_workers=self.n_jobs) as executor:
                futures = {
                    executor.submit(
                        self._evaluate_params, params, series, exog, country_holidays, custom_holidays
    ...
    def _evaluate_params(
        ...
        (changepoint_prior_scale, seasonality_prior_scale, holidays_prior_scale,
         seasonality_mode, growth, yearly_seasonality, weekly_seasonality, 
         daily_seasonality, n_changepoints) = params
