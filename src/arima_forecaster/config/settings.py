...
class ARIMAConfig:
    ...
    def _load_env_vars(self) -> None:
        ...
        self.max_gpu_models_parallel = int(
            os.getenv("ARIMA_MAX_GPU_PARALLEL", self.max_gpu_models_parallel)
        )
        ...
        self.default_max_iterations = int(
            os.getenv("ARIMA_MAX_ITERATIONS", self.default_max_iterations)
        )
        self.convergence_tolerance = float(
            os.getenv("ARIMA_CONVERGENCE_TOL", self.convergence_tolerance)
        )
        ...
        self.feature_selection_method = os.getenv(
            "ARIMA_FEATURE_SELECTION", self.feature_selection_method
        )
