        ...
        try:
            ...
            if len(actual) == 0:
                raise ValidationError(
                    "Nessun punto dati valido dopo aver rimosso valori NaN/infiniti"
                )
            ...
            if return_all:
                ...
                additional_metrics = {
                    ...
                    "iqr_error": np.percentile(abs_errors, 75)
                    - np.percentile(abs_errors, 25),  # IQR degli errori
        ...
        try:
            ...
            if fitted_values is not None:
                ...
                if len(fitted_values) == len(residuals):
                    ...
                    diagnostics["breusch_pagan_test"] = self._breusch_pagan_test(
                        clean_residuals, clean_fitted
                    )
