...
class MemoryPool:
    ...
    def __init__(
        self, max_array_size: int = 10000, max_pool_size: int = 20, enable_monitoring: bool = True
    ):
...
def configure_memory_pool(
    max_array_size: int = 10000, max_pool_size: int = 20, enable_monitoring: bool = True
):
