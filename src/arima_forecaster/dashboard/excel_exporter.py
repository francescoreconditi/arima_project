...
class ProcurementExcelExporter:
    ...
    def _create_executive_summary(self, writer: pd.ExcelWriter, inventory_params: Dict[str, Any]):
        ...
        kpi_data = {
            ...
            'Status': [
                ...
                '✅ Buono',
                '✅ Target' if inventory_params.get('forecast_accuracy', 0.847) > 0.85 else '⚠️ Migliorabile'
            ],
            'Azione Richiesta': [
    ...
    def _create_performance_analysis(self, writer: pd.ExcelWriter, inventory_params: Dict[str, Any]):
