...
'''
    ...
    def _render_report(self, qmd_path: Path, format_type: str, output_filename: str) -> Path:
        ...
        try:
            ...
            if temp_output_path.exists():
                ...
                if format_type == "html":
                    self._fix_html_image_paths(final_output_path, output_filename)
    ...
    def _fix_html_image_paths(self, html_path: Path, output_filename: str) -> None:
        """Fix all resource paths in HTML file after moving it from temp directory."""
        try:
            # Read the HTML file
            ...
            self.logger.warning(f"Could not fix HTML resource paths: {e}")
