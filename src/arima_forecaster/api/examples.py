...
ARIMA_TRAINING_EXAMPLES = {
    "arima_automatico": {
        ...
        "value": {
            ...
            "model_params": {"order": None, "seasonal_order": None, "auto_select": True},
        },
    },
    "arima_manuale": {
        ...
        "value": {
            ...
            "data": TIMESERIES_EXAMPLES["esempio_base"]["value"],
            "model_params": {"order": [2, 1, 1], "seasonal_order": None, "auto_select": False},
        },
    },
}
...
TRAINING_RESPONSE_EXAMPLES = {
    "training_success": {
        ...
        "value": {
            ...
            "model_id": "vendite_arima_auto",
            "model_type": "ARIMA",
            "parameters": {"order": [2, 1, 1], "seasonal_order": None},
            "performance_metrics": {
                "aic": 245.67,
                "bic": 255.32,
                "mae": 45.23,
    ...
    "diagnostics_complete": {
        ...
        "value": {
            ...
            "residuals_analysis": {
                ...
                "skewness": -0.15,
                "kurtosis": 3.24,
                "jarque_bera": {"statistic": 2.45, "p_value": 0.29, "normality_confirmed": True},
            },
            ...
            "information_criteria": {"aic": 245.67, "bic": 255.32, "hqic": 249.12},
            "performance_metrics": {
                "in_sample": {"mae": 45.23, "rmse": 58.91, "mape": 3.87, "r_squared": 0.87},
                "cross_validation": {"cv_mae": 52.18, "cv_rmse": 67.23, "cv_mape": 4.52},
            },
            "model_stability": {
    ...
    "websocket_connection": {
        ...
        "value": {
            ...
            "real_time_data": {
                ...
                "anomaly_score": 0.02,
                "feature_importance": {"lag_1": 0.45, "trend": 0.32, "seasonal": 0.23},
            },
        },
    },
}
