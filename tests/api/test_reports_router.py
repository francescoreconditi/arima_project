...
class TestReportGeneration:
    ...
    def test_generate_report_success(
        self, client: TestClient, trained_model_id, sample_report_request
    ):
        """Test generazione report con successo."""
        response = client.post(f"/models/{trained_model_id}/report", json=sample_report_request)
    ...
    def test_generate_report_different_formats(self, client: TestClient, trained_model_id):
        ...
        for fmt in formats:
            ...
            response = client.post(f"/models/{trained_model_id}/report", json=report_request)
    ...
    def test_generate_report_custom_options(self, client: TestClient, trained_model_id):
        ...
        response = client.post(f"/models/{trained_model_id}/report", json=custom_request)
    ...
    def test_generate_report_minimal_options(self, client: TestClient, trained_model_id):
        ...
        response = client.post(f"/models/{trained_model_id}/report", json=minimal_request)
    ...
    def test_generate_report_nonexistent_model(self, client: TestClient, sample_report_request):
        ...
        response = client.post(f"/models/{fake_model_id}/report", json=sample_report_request)
    ...
    def test_generate_report_invalid_format(self, client: TestClient, trained_model_id):
        ...
        response = client.post(f"/models/{trained_model_id}/report", json=invalid_request)
...
class TestReportWorkflow:
    ...
    def test_generate_and_check_status_workflow(self, client: TestClient, trained_model_id):
        ...
        gen_response = client.post(f"/models/{trained_model_id}/report", json=report_request)
    ...
    def test_multiple_reports_same_model(self, client: TestClient, trained_model_id):
        ...
        report_request = {"format": "html", "include_diagnostics": True, "include_forecasts": True}
    ...
    def test_concurrent_report_generation(self, client: TestClient, trained_model_id):
        ...
        def generate_report():
            return client.post(f"/models/{trained_model_id}/report", json={"format": "html"})
...
class TestReportValidation:
    ...
    def test_report_request_validation(self, client: TestClient, trained_model_id):
        ...
        response = client.post(f"/models/{trained_model_id}/report", json=full_request)
    ...
    def test_report_boolean_validation(self, client: TestClient, trained_model_id):
        ...
        bool_request = {"format": "html", "include_diagnostics": True, "include_forecasts": False}

        response = client.post(f"/models/{trained_model_id}/report", json=bool_request)
        ...
        response = client.post(f"/models/{trained_model_id}/report", json=invalid_bool_request)
    ...
    def test_report_steps_validation(self, client: TestClient, trained_model_id):
        ...
        for steps in valid_steps:
            request = {"format": "html", "forecast_steps": steps}

            response = client.post(f"/models/{trained_model_id}/report", json=request)
...
class TestReportErrorHandling:
    ...
    def test_malformed_report_requests(self, client: TestClient, trained_model_id):
        ...
        for malformed_request in malformed_requests:
            response = client.post(f"/models/{trained_model_id}/report", json=malformed_request)
