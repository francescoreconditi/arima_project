...
class TestMovementClassifier:
    ...
    def test_classify_movement_speed(self, sample_data):
        ...
        # Test fast moving
        fast_result = classifier.classify_movement_speed(
            sample_data['fast_moving'].values
        )
        assert fast_result['classification'] == 'fast_moving'
        assert fast_result['avg_sales'] > 80
        
        # Test slow moving
        slow_result = classifier.classify_movement_speed(
            sample_data['slow_moving'].values
        )
...
class TestSlowFastOptimizer:
    ...
    def test_pooling_strategy(self, optimizer):
        ...
        slow_data = {
            loc: np.random.poisson(1, 100) for loc in locations
        }
...
class TestCapacityConstrainedOptimizer:
    ...
    def test_pallet_optimization(self, optimizer):
        ...
        result = optimizer.optimize_pallet_configuration(
            products,
            max_pallets=5
        )
...
class TestIntegration:
    ...
    def test_complete_inventory_optimization(self):
        ...
        inventory_params = optimizer.optimize_inventory(
            sales_data, 
    ...
    def test_multi_location_optimization(self):
        ...
        final_result = capacity_optimizer.optimize_with_constraints(
