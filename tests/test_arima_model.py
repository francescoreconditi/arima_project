...
class TestARIMAForecaster:
    ...
    def test_forecast_with_confidence_intervals(self, fitted_model):
        ...
        forecast, conf_int = fitted_model.forecast(
            steps=5, confidence_intervals=True, return_conf_int=True
        )
    ...
    def test_forecast_different_alpha(self, fitted_model):
        ...
        _, conf_int_95 = fitted_model.forecast(steps=3, alpha=0.05, return_conf_int=True)
        _, conf_int_90 = fitted_model.forecast(steps=3, alpha=0.10, return_conf_int=True)
    ...
    def test_fit_with_missing_values_warning(
        self, arima_model, sample_time_series_with_missing, caplog
    ):
