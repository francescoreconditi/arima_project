...
def test_shap_explainer_config():
    ...
    custom_config = SHAPConfig(explainer_type="tree", background_samples=50, max_evals=100)
...
def test_business_context_creation():
    ...
    # Context minimo
    context = BusinessContext(model_id="test_model", forecast_date=datetime.now())
