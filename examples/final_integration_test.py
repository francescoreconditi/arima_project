...
def test_excel_export():
    ...
    from arima_forecaster.dashboard.excel_exporter import (
        ProcurementExcelExporter, create_sample_procurement_data
    )
    import openpyxl
...
def test_scenario_simulator():
    ...
    from arima_forecaster.dashboard.scenario_simulator import (
        WhatIfScenarioSimulator, ScenarioParameters, ScenarioType, create_sample_base_data
    )
    ...
    for scenario_name, test_params in test_scenarios:
        _, test_results = simulator.run_scenario_simulation(test_params, base_forecast, base_metrics)
...
def test_complete_integration():
    ...
    from arima_forecaster.dashboard.mobile_responsive import MobileResponsiveManager
    from arima_forecaster.dashboard.excel_exporter import ProcurementExcelExporter, create_sample_procurement_data
    from arima_forecaster.dashboard.scenario_simulator import WhatIfScenarioSimulator, ScenarioParameters, create_sample_base_data
    ...
    output_file = Path(__file__).parent / f"integration_test_result_{datetime.now().strftime('%Y%m%d_%H%M%S')}.xlsx"
