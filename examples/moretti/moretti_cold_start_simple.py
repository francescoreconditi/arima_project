...
def create_demo_data():
    ...
    # Info prodotti
    prodotti_info = {
        'CRZ001': {'nome': 'Carrozzina Standard', 'categoria': 'Carrozzine', 'prezzo': 450.0, 'peso': 12.0},
        'MAT001': {'nome': 'Materasso Antidecubito', 'categoria': 'Materassi Antidecubito', 'prezzo': 250.0, 'peso': 8.0},
        'ELT001': {'nome': 'Saturimetro Digitale', 'categoria': 'Elettromedicali', 'prezzo': 89.0, 'peso': 0.3}
    }
